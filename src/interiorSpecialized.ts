...
export function buildGalleryInterior(ctx: SpecializedContext) {
  ...
  rooms.push({ name: 'Коммерческая Торговая Галерея', x: 6, y: 6, width: W - 12, height: H - 12, color: '#1e293b', floorStyle: 'tile' });

  // Central Lounge Seating & Carpet
  furniture.push({ type: 'carpet', x: W / 2 - 25, y: H / 2 - 12, width: 50, height: 24, angle: 0, color: '#334155' });
  furniture.push({ type: 'sofa', x: W / 2 - 22, y: H / 2 - 8, width: 20, height: 8, angle: 0, color: '#0284c7' });
  furniture.push({ type: 'sofa', x: W / 2 + 2, y: H / 2 - 8, width: 20, height: 8, angle: 0, color: '#0284c7' });

  // ATM Bank & Refreshment Vending
  furniture.push({ type: 'atm', x: 14, y: 14, width: 8, height: 8, angle: 0, color: '#0284c7' });
  furniture.push({ type: 'vending_machine', x: 26, y: 14, width: 10, height: 8, angle: 0, color: '#475569' });
  furniture.push({ type: 'cooler', x: 40, y: 14, width: 8, height: 8, angle: 0, color: '#38bdf8' });

  // Kiosk / Information Desk
  furniture.push({ type: 'counter', x: W - 40, y: 14, width: 26, height: 10, angle: 0, color: '#38bdf8' });
  furniture.push({ type: 'cash_register', x: W - 36, y: 16, width: 6, height: 4, angle: 0, color: '#0f172a' });

  // Boutique Showcase Shelves
  furniture.push({ type: 'shelf', x: 14, y: H - 22, width: 28, height: 8, angle: 0, color: '#64748b' });
  furniture.push({ type: 'shelf', x: W - 44, y: H - 22, width: 28, height: 8, angle: 0, color: '#64748b' });
}
